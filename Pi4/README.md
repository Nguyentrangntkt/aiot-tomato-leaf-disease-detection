...
## Phạm vi repository
Tổng quan toàn hệ thống xem tại [README chính](../README.md).
...
cp .env.example .env
```
Điền thông tin cấu hình vào file `.env` trên thiết bị triển khai. Không commit `.env` hoặc bất kỳ credential nào lên Git.
